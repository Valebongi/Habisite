...
const ConcursosTab: React.FC = () => {
  ...
  return (
    <IonPage>
      <PostulanteHeader titulo="Concursos" />
      <IonContent style={{ '--background': '#f4f5f7' }}>
...
const EntregasTab: React.FC = () => {
  ...
  return (
    <IonPage>
      <PostulanteHeader titulo="Mis Entregas" />
      <IonContent style={{ '--background': '#f4f5f7' }}>
        {!mostrarForm && (
...
const PostulantePage: React.FC = () => (
  ...
  <IonTabs>
    <IonRouterOutlet>
      ...
      <Route exact path="/postulante/concursos" component={ConcursosTab} />
      <Route exact path="/postulante/entregas" component={EntregasTab} />
